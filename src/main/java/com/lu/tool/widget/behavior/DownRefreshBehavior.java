...
public class DownRefreshBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, View child, int layoutDirection) {
        if (mChild == null) {
            ...
            child.setTranslationY(-mHeight * 1.2f);
    ...
    public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View child, @NonNull View directTargetChild, @NonNull View target, int axes, int type) {
        return (axes & ViewCompat.SCROLL_AXIS_VERTICAL) != 0 && !mDoRefresh;
    }
    ...
    @Override
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, final View child, final View target,int type) {
        if (mIsAnimating) {
